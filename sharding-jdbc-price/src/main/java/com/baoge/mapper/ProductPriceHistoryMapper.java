...
public interface ProductPriceHistoryMapper {
    ...
    @Insert("INSERT INTO product_price_history (id, price_id, product_id, sku_id, price, original_price, cost_price, start_time, end_time, status, create_time, update_time) " +
            "VALUES (#{id}, #{priceId}, #{productId}, #{skuId}, #{price}, #{originalPrice}, #{costPrice}, #{startTime}, #{endTime}, #{status}, #{createTime}, #{updateTime})")
